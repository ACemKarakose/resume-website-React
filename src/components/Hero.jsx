...
import ProfilePic from  '../assets/cemKarakoseSide.jpeg'
                ...
                <div className="w-full lg:w-1/2">
                    <div className="flex flex-col items-center lg:items-start">
                        <motion.h1
                            ...
                            initial={'hidden'}
                            animate={'visible'}
                            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">A.Cem Karakose</motion.h1>
                        <motion.span
                        ...
                        <motion.p   variants={animationContainer(1)}
                                    initial={'hidden'}
                ...
                <div className="w-full lg:w-1/2 lg:p--8 ">
                    <div className="flex justify-center">
                        <motion.img
                            ...
                            src={ProfilePic} alt="profilePicc"/>
                    </div>
                </div>
            </div>
        </div>
